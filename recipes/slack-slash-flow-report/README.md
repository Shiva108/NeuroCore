# Slack Slash Flow Report

## What it does

This recipe provides an end-to-end slash-style workflow for generating a memory
review report from Slack activity captured in NeuroCore.

## Prerequisites

- [Slack starter integration](../../integrations/slack-starter/README.md)
- NeuroCore runtime with ingest and query access
- Reporting extension module under `src/neurocore/reporting/`

## Flow

1. Capture Slack activity with `neurocore ingest slack`.
